import { clear, del, get, JAXDiskStore, keys, set } from './JAXDiskDB.js'
import pathLib from './JAXPath.js'
...
//***************************************************************************
{
	...
	JAXDisk.dropDisk = async function (diskName) {
		let self,diskObj;
		self=this;
				...
				navigator.serviceWorker.onmessage=function(event){
					...
					switch(msg){
						case "WatchOK":
							...
							//navigator.serviceWorker.controller.postMessage({msg:"Unwatch",watchId:data.watchId});
